      ...
      <div className="card shrink-0 w-full max-w-md mx-auto shadow-2xl bg-base-100">
        <form className="card-body" onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="form-control">
            ...
            <input className="input input-bordered" placeholder="Your name" {...register("name",{required:true})} />
          ...
          <div className="form-control">
            ...
            <div className="form-control">
              ...
              <input className="input input-bordered" placeholder="Your photo url" {...register("photo",{required:true})} />
          ...
          <div className="form-control mt-6">
            <button className="btn bg-[#FFC801] text-xl font-bold text-white">SignUp</button>
          </div>
        </form>
      </div>
      <img
